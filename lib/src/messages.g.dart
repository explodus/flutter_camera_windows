...
abstract class CameraEventApi {
  ...
  static void setUp(CameraEventApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.camera_windows.CameraEventApi.frameAvailabledEvent$messageChannelSuffix', pigeonChannelCodec,
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.camera_windows.CameraEventApi.frameAvailabledEvent was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_cameraId = (args[0] as int?);
          assert(arg_cameraId != null,
              'Argument for dev.flutter.pigeon.camera_windows.CameraEventApi.frameAvailabledEvent was null, expected non-null int.');
          final Uint8List? arg_imageBytes = (args[1] as Uint8List?);
          assert(arg_imageBytes != null,
              'Argument for dev.flutter.pigeon.camera_windows.CameraEventApi.frameAvailabledEvent was null, expected non-null Uint8List.');
          try {
            api.frameAvailabledEvent(arg_cameraId!, arg_imageBytes!);
